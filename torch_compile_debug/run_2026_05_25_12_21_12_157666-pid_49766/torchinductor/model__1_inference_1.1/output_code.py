...
# kernel path: /tmp/torchinductor_gg/tf/ctfclr5fbuvnx3lseypf6cx6bp557ij773vtyfbrdf2dosrrsqeq.py
# Topologically Sorted Source Nodes: [mul, acc, mul_1, acc_1], Original ATen: [aten.mul, aten.add]
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            # Topologically Sorted Source Nodes: [mul, acc, mul_1, acc_1], Original ATen: [aten.mul, aten.add]
            # [Provenance debug handles] triton_poi_fused_add_mul_0:2
