...
# kernel path: /tmp/torchinductor_gg/au/cauzvhoycwzgpilg2qgrmuxtmisyaxc2x45lolptrbz6n5eakezt.py
# Topologically Sorted Source Nodes: [mul, acc, mul_1, acc_1, mul_2, acc_2, mul_3, acc_3], Original ATen: [aten.mul, aten.add]
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            # Topologically Sorted Source Nodes: [mul, acc, mul_1, acc_1, mul_2, acc_2, mul_3, acc_3], Original ATen: [aten.mul, aten.add]
            # [Provenance debug handles] triton_poi_fused_add_mul_0:3
